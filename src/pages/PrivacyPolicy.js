      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Izon Voice, No 30 Ebis Mechanic Road,
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Izon Voice, accessible from{" "}
            <a
              href="http://izonvoice.ng"
      ...
      <ul>
        <li>
          ...
          <a
            ...
            class="__cf_email__"
            data-cfemail="cca5a2aaa38ca5b6a3a2baa3a5afa9e2a2ab"
          >
            [email&#160;protected]
          </a>
        </li>
